...
router.get('/google/callback', passport_1.default.authenticate('google', { failureRedirect: '/exercise' }), (req, res) => {
    // Successful authentication, redirect home.
    console.log('Authenticated User:', req.user);
    res.redirect('/user/google/' + req.user?.googleId); // Redirect to user profile or desired page
});
router.get('/logout', index_1.default.handleErrors(authController.logout));
